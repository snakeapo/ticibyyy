                ...
                <div class="col-12">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Duyuru Ayarları</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Duyuru Ayarları</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Duyuru Ayarları</h4>
                            </div>
                            <div class="card-body">
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $key->title }}</td>
                                            <td>{{ $key->annons_desc }}</td>
                                            <td>
                                                @if($key->status == 1)
                                                <p style="color: rgb(66, 167, 66)">Aktif</p>
                                                @else
                                                <p style="color: rgb(216, 79, 79)">Pasif</p>
                                                @endif
                                            </td>
                                            <td><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit{{ $key->id }}" type="button">Düzenle</button></td>
                                            <td><a href="{{ route('annons_delete',$key->id) }}" onclick="confirmation(event)" class="btn btn-danger">Sil</a></td>
                                        </tr>
                                        <!-- Modal -->
                                        <div class="modal fade" id="edit{{ $key->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Duyuruyu Düzenleyin</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form action="{{ route('annons_update',$key->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <input type="text" required name="annons_desc" value="{{ $key->annons_desc }}" class="form-control" id="floatingInput" placeholder="">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Yeni Duyuru Oluşturun</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('annons_create') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-floating mb-3">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" required name="annons_desc" class="form-control" id="floatingInput" placeholder="">
                                        <label for="floatingInput">Açıklama</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <select name="status" required class="form-control" id="">
