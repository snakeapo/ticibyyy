                ...
                <div class="col-12">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Bilgilendirme</h4>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Bilgilendirme Listesi</h4>
                                <div class="float-end">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#ekle" class="btn btn-primary">Bilgi Ekle</a>
                                </div>
                                <!-- Modal -->
                                <div class="modal fade" id="ekle" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Yeni Bilgi Ekleyin</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                        <form action="{{ route('info_setting_create') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="/upload/info/{{ $key->image }}" class="img-fluid" width="40" alt=""></td>
                                            <td>{{ $key->title }}</td>
                                            <td><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit{{ $key->id }}" type="button">Düzenle</button></td>
                                            <td><a href="{{ route('info_setting_delete',$key->id) }}" onclick="confirmation(event)" class="btn btn-danger">Sil</a></td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="edit{{ $key->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('info_setting_update',$key->id) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="form-floating mb-3">
                                                        ...
                                                        <div class="form-floating mb-3">
                                                            <textarea name="description" class="form-control" required id="" cols="30" rows="10">{{ $key->description }}</textarea>
                                                            <label for="floatingInput">Açıklama</label>
                                                        </div>
                                                </div>
                                                <div class="modal-footer">
