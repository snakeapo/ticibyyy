        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Yeni Alt Kategori Oluştur</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('subcategory_create') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-floating mb-3">
                                    <input type="text" required name="sub_title" value="{{ old('sub_title') }}" class="form-control" id="floatingInput" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-select" required name="parent_target" id="floatingSelect" aria-label="">
                                        ...
                                        @foreach ($parentOptions as $option)
                                            <option value="{{ $option['value'] }}" @selected(old('parent_target') == $option['value'])>{{ $option['label'] }}</option>
                                        @endforeach
                                    </select>
