...
@section('content')
        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Yazı Düzenle</h4>
                        </div>
            ...
            <!-- end page title -->
                ...
                <form action="{{ route('blog_update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-floating mb-3">
                                    <input type="text" required name="blog_title" value="{{ $data->blog_title }}" class="form-control" id="floatingInput" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" required name="blog_tag" value="{{ $data->blog_tag }}" class="form-control" id="floatingInput" placeholder="">
                                    <label for="floatingInput">Yazı Tagları</label>
                                </div>
                                <div class="mb-3">
                                    <label label class="mb-2">Blog Açıklaması</label>
                                    <textarea class="form-control" name="blog_desc" required id="desc" rows="10" cols="80">{{ $data->blog_desc }}</textarea>
                                </div>
                            </div> <!-- end card body-->
                        </div> <!-- end card -->
                    </div> <!-- end card -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <img src="/upload/blog/{{ $data->image }}" class="img-fluid" alt="">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" name="meta_title" required class="form-control" value="{{ $data->meta_title }}" id="" placeholder="">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="form-label">Meta Anahtar Kelime</label>
                                    <input type="text" name="meta_keyw" required class="form-control" value="{{ $data->meta_keyw }}" id="" placeholder="">
                                </div>
                                <div class="col-md-12 mb-3">
                                    <label for="form-label">Meta Açıklama</label>
                                    <input type="text" name="meta_desc" required class="form-control" value="{{ $data->meta_desc }}" id="" placeholder="">
                                </div>
