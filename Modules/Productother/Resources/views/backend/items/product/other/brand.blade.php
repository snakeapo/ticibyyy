            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="header-title">Yeni Marka Oluştur</h4>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('brand_create') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-floating mb-3">
                                        <input type="text" required name="brand_title" value="{{ old('brand_title') }}" class="form-control" placeholder="">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="meta_title" class="form-control" value="{{ old('meta_title') }}" placeholder="">
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label>Meta Anahtar Kelime</label>
                                        <input type="text" name="meta_keyw" class="form-control" value="{{ old('meta_keyw') }}" placeholder="">
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label>Meta Açıklama</label>
                                        <input type="text" name="meta_desc" class="form-control" value="{{ old('meta_desc') }}" placeholder="">
                                    </div>
                                    <div class="mb-3">
